...
;; Deposit STX as collateral to earn yield and unlock borrowing capacity
...
;; Borrow STX against deposited collateral with automated risk checks
...
;; Repay borrowed STX to reduce debt and improve collateral ratio
...
;; Withdraw collateral with safety checks to prevent under-collateralization
